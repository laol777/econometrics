...
X = data.frame(value = c(590426,598539,592443,594720,575901,570319,596480,593475,592177,594807,595212,577716,576297,603203,
...
acf(X$value)
# видим затухающую корреляционную связь, но так же видим, что есть два всплекска - с лагом 7 и 14 - следовательно
# есть периодические колебания

## метод сравнения средних
X2 = data.frame(x1 = X$value[1:30], x2 = X$value[31:60])
var.test(X2$x1 - mean(X2$x1), X2$x2  - mean(X2$x2))
